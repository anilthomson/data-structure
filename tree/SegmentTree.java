...
class SegmentTree {
	...
	int constructSTUtil(int arr[], int ss, int se, int si) {
		...
		int left = constructSTUtil(arr, ss, mid, si * 2 + 1);
		int right = constructSTUtil(arr, mid + 1, se, si * 2 + 2);
		st[si] = left + right;
	...
	public static void main(String args[]) {
		int arr[] = { 0, +1, -2, +3, -4, +5, -6 };// {1, 3, 5, 7, 9, 11};
		int n = arr.length;
		...
		System.out.println("Sum of values in given range = 3,6 " + tree.getSum(n, 3, 6));
